export const messages = {
  en: {
    ...
    hubs: {
      ...
      quotes: {
        title: "Daily Quotes — Bhakti Lines to Sit With",
        description: "A quiet list of published bhakti quotes. Search and read them without noise.",
        h1: "Quotes",
      },
      bhajan: {
      ...
      spiritualTools: {
        ...
        description:
          "Explore our suite of free, private, 100% secure Vedic tools. Generate your Daily Panchang, Free Janam Kundli, and Kundli Milan locally on your device.",
        h1: "BhaktiVoice Spiritual Tools",
      },
      panchangTool: {
        title: "Today's Daily Panchang | Accurate Tithi, Nakshatra & Muhurat",
        description:
          "Get today's detailed Panchang based on your location. Check Tithi, Nakshatra, Yoga, Karana, Rahu Kaal, and Shubh Muhurat. Calculated instantly on your device.",
        h1: "Daily Panchang",
      },
      kundliTool: {
        title: "Free Janam Kundli Online | Exact Birth Chart Calculator",
        description:
          "Generate your detailed Janam Kundli online for free. 100% secure—your birth details are processed locally on your device and never stored.",
        h1: "Free Kundli / Birth Chart",
      },
      kundliMilanTool: {
        title: "Kundli Milan & 36 Guna Matching | Free Marriage Compatibility",
        description:
          "Check marriage compatibility with our free Ashtakoot Kundli Milan tool. Calculates 36 Guna matching instantly and privately on your device.",
        h1: "Kundli Milan / 36 Guna Matching",
      },
    },
    spiritualTools: {
      privacyNotice: "Your birth details are calculated locally on your device.",
      allTools: "All Spiritual Tools",
      openTool: "Open tool",
      landingLead:
        "100% secure, private Vedic calculators — Panchang, Janam Kundli, and Kundli Milan. Nothing leaves your browser.",
      tools: {
        panchang: {
          title: "Daily Panchang",
          description: "Get today's Tithi, Nakshatra, and Muhurat based on your exact location.",
        },
        kundli: {
          title: "Free Kundli",
          description: "Generate your precise Janam Patrika. 100% private and calculated on your device.",
        },
        milan: {
          title: "Kundli Milan",
          description: "Check marriage compatibility with traditional 36 Guna Ashtakoot matching.",
        },
      },
      panchang: {
        formTitle: "Location",
        formLead: "Choose your city or use your device location. Timings are calculated for your latitude and longitude.",
        useLocation: "Use my location",
        selectCity: "Select city",
        calculating: "Calculating Panchang…",
        resultTitle: "Today's Panchang",
        weekday: "Weekday",
        tithi: "Tithi",
        nakshatra: "Nakshatra",
        yoga: "Yoga",
      ...
      milan: {
        boyTitle: "Boy's birth details",
        girlTitle: "Girl's birth details",
        name: "Name",
        date: "Date of birth",
        time: "Time of birth",
        place: "Place of birth",
        placeHint: "Start typing a city…",
        submit: "Calculate 36 Guna Milan",
        calculating: "Matching Gunas…",
        resultTitle: "Ashtakoot Milan Result",
        boyDefault: "Boy",
        girlDefault: "Girl",
        boyMoon: "Boy's Moon",
        girlMoon: "Girl's Moon",
      },
    },
    common: {
      read: "Read",
      ...
      communityMembers: "Members in this sangha",
      communityStart: "Start a message",
      communityReply: "Reply",
      communityPost: "Post",
      communityNeedJoin: "Join this sangha to write. Anyone here may reply on the same thread.",
      communityNeedSignIn: "Sign in with Google to join this community.",
      communityAbuse: "Please keep the language gentle — in English or Hindi.",
      communityEmpty: "No messages yet. Be the first to share a naam or a kindness.",
      communityWrite: "A short note for the sangha…",
      communityReplyHint: "Reply on this thread…",
      communityCreate: "Create a community",
      communityCreateHint: "You can create up to 3. You will be the admin and start the posts. Others may join and comment.",
      communityName: "Community name",
      communityAbout: "About this sangha",
      communityCreateCta: "Create",
      communityAdmin: "Admin",
      communityAdminOnly: "Only the admin can start a post. Members may join and comment.",
      communityDevoteeGroups: "Devotee communities",
      communityLimit: "You already have 3 communities.",
      devotees: "devotees",
      edit: "Edit",
      dailyQuote: "Daily quote",
      quoteSearch: "Search quotes",
      quotesEmpty: "No quotes yet.",
      quotesNone: "No quotes match that search.",
      listingSearch: (label: string) => `Search for ${label.toLowerCase()}...`,
      listingSearchNone: "Nothing on this page matches that search.",
      bhajanSearchPlaceholder: "Search for bhajan, kirtan, aarti, mantra...",
      ...
      outOfStockNote: "This item is listed so you can see it, but it is currently out of stock.",
  ...
  hi: {
    ...
    hubs: {
      ...
      quotes: {
        title: "दैनिक उद्धरण — बैठने योग्य भक्ति वचन",
        description: "प्रकाशित भक्ति उद्धरणों की शांत सूची। खोजें और बिना शोर के पढ़ें।",
        h1: "उद्धरण",
      },
      bhajan: {
      ...
      spiritualTools: {
        ...
        description:
          "मुफ्त, निजी, 100% सुरक्षित वैदिक उपकरण। दैनिक पंचांग, जन्म कुंडली और कुंडली मिलान अपने डिवाइस पर बनाएँ।",
        h1: "BhaktiVoice आध्यात्मिक उपकरण",
      },
      panchangTool: {
        title: "आज का दैनिक पंचांग | सटीक तिथि, नक्षत्र और मुहूर्त",
        description:
          "अपने स्थान के अनुसार आज का विस्तृत पंचांग। तिथि, नक्षत्र, योग, करण, राहु काल — तुरंत आपके डिवाइस पर।",
        h1: "दैनिक पंचांग",
      },
      kundliTool: {
        title: "मुफ्त जन्म कुंडली ऑनलाइन | सटीक जन्म पत्रिका",
        description:
          "अपनी विस्तृत जन्म कुंडली मुफ्त बनाएँ। 100% सुरक्षित — जन्म विवरण केवल आपके डिवाइस पर संसाधित होते हैं।",
        h1: "मुफ्त कुंडली / जन्म पत्रिका",
      },
      kundliMilanTool: {
        title: "कुंडली मिलान और 36 गुण मिलान | विवाह अनुकूलता",
        description:
          "मुफ्त अष्टकूट कुंडली मिलान से विवाह अनुकूलता जाँचें। 36 गुण मिलान तुरंत और निजी तौर पर।",
        h1: "कुंडली मिलान / 36 गुण मिलान",
      },
    },
    spiritualTools: {
      privacyNotice: "आपके जन्म विवरण केवल आपके डिवाइस पर गणना होते हैं।",
      allTools: "सभी आध्यात्मिक उपकरण",
      openTool: "उपकरण खोलें",
      landingLead:
        "100% सुरक्षित, निजी वैदिक कैलकुलेटर — पंचांग, जन्म कुंडली और कुंडली मिलान। कुछ भी ब्राउज़र से बाहर नहीं जाता।",
      tools: {
        panchang: {
          title: "दैनिक पंचांग",
          description: "अपने स्थान के अनुसार आज की तिथि, नक्षत्र और मुहूर्त देखें।",
        },
        kundli: {
          title: "मुफ्त कुंडली",
          description: "सटीक जन्म पत्रिका बनाएँ। 100% निजी — आपके डिवाइस पर गणना।",
        },
        milan: {
          title: "कुंडली मिलान",
          description: "पारंपरिक 36 गुण अष्टकूट मिलान से विवाह अनुकूलता जाँचें।",
        },
      },
      panchang: {
        formTitle: "स्थान",
        formLead: "अपना शहर चुनें या डिवाइस का स्थान उपयोग करें। समय आपके अक्षांश-देशांतर के अनुसार गणना होते हैं।",
        useLocation: "मेरा स्थान उपयोग करें",
        selectCity: "शहर चुनें",
        calculating: "पंचांग गणना हो रही है…",
        resultTitle: "आज का पंचांग",
        weekday: "वार",
        tithi: "तिथि",
        nakshatra: "नक्षत्र",
        yoga: "योग",
      ...
      kundli: {
        ...
        placeHint: "शहर लिखें…",
        submit: "कुंडली बनाएँ",
        calculating: "ग्रह स्थिति गणना…",
        resultTitle: "आपकी जन्म कुंडली",
        lagna: "लग्न",
        moonSign: "चंद्र राशि",
        sunSign: "सूर्य राशि",
        ...
        planet: "ग्रह",
        sign: "राशि",
        nakshatraCol: "नक्षत्र",
        retrograde: "वक्री",
        yes: "हाँ",
      },
      milan: {
        boyTitle: "वर के जन्म विवरण",
        girlTitle: "वधू के जन्म विवरण",
        name: "नाम",
        date: "जन्म तिथि",
        time: "जन्म समय",
        place: "जन्म स्थान",
        placeHint: "शहर लिखें…",
        submit: "36 गुण मिलान करें",
        calculating: "गुण मिलान हो रहा है…",
        resultTitle: "अष्टकूट मिलान परिणाम",
        boyDefault: "वर",
        girlDefault: "वधू",
        boyMoon: "वर का चंद्र",
        girlMoon: "वधू का चंद्र",
      },
    },
    common: {
      read: "पढ़ें",
      ...
      communityMembers: "इस संघ में सदस्य",
      communityStart: "एक संदेश शुरू करें",
      communityReply: "उत्तर दें",
      communityPost: "भेजें",
      communityNeedJoin: "लिखने के लिए इस संघ से जुड़ें। यहाँ कोई भी उसी धागे पर उत्तर दे सकता है।",
      communityNeedSignIn: "इस समुदाय से जुड़ने के लिए Google से साइन इन करें।",
      communityAbuse: "भाषा शांत रखें — अंग्रेज़ी या हिंदी में गाली नहीं।",
      communityEmpty: "अभी संदेश नहीं। नाम या एक दया लिखकर आरंभ करें।",
      communityWrite: "संघ के लिए एक छोटा संदेश…",
      communityReplyHint: "इस धागे पर उत्तर…",
      communityCreate: "समुदाय बनाएँ",
      communityCreateHint: "आप तीन तक बना सकते हैं। आप एडमिन होंगे और पोस्ट आप शुरू करेंगे। अन्य लोग जुड़कर टिप्पणी कर सकते हैं।",
      communityName: "समुदाय का नाम",
      communityAbout: "इस संघ के बारे में",
      communityCreateCta: "बनाएँ",
      communityAdmin: "एडमिन",
      communityAdminOnly: "पोस्ट केवल एडमिन शुरू कर सकता है। सदस्य जुड़कर टिप्पणी कर सकते हैं।",
      communityDevoteeGroups: "भक्तों के समुदाय",
      communityLimit: "आपके पास पहले से तीन समुदाय हैं।",
      devotees: "भक्त",
      edit: "संपादित करें",
      dailyQuote: "दैनिक वचन",
      quoteSearch: "उद्धरण खोजें",
      quotesEmpty: "अभी उद्धरण नहीं हैं।",
      quotesNone: "कोई उद्धरण नहीं मिला।",
      listingSearch: (label: string) => `${label} खोजें...`,
      listingSearchNone: "इस पृष्ठ पर उस खोज से कुछ नहीं मिला।",
      bhajanSearchPlaceholder: "भजन, कीर्तन, आरती, मंत्र खोजें...",
      ...
      outOfStockNote: "यह वस्तु भंडार में दिख रही है, पर अभी उपलब्ध नहीं है।",
  ...
  te: {
    ...
    languageName: "తెలుగు",
    otherLanguageName: "English",
    footerTagline: "ఆధ్యాత్మిక ప్రయాణంలో మీ దివ్య సహచరి — జపించండి, నేర్చుకోండి, పుణ్యక్షేత్రాలను దర్శించండి, ప్రతిరోజూ ఆనందాన్ని పొందండి.",
    footerMotto: "భక్తితో జీవించండి. శాంతితో వర్ధిల్లండి.",
    footerCredit: "భక్తుల కోసం రూపొందించబడింది, నిత్య ఆధ్యాత్మిక అన్వేషణ కోసం నిర్మించబడింది.",
    newsletterTitle: "మా భక్తి యాత్రలో భాగస్వాములు కండి",
    newsletterBody: "కథలు, జపం మరియు పవిత్ర పర్వదినాల సమాచారం — నిర్మలంగా మీ ముందుకు.",
    newsletterPlaceholder: "మీ ఈమెయిల్",
    subscribe: "సబ్‌స్క్రైబ్",
    newsletterThanks: "భక్తి వాయిస్‌తో కలిసి పయనిస్తున్నందుకు ధన్యవాదాలు.",
    madeInIndia: "భారతదేశంలో ❤️ తో నిర్మించబడింది",
    empty: (label: string) => `ఇంకా ${label} అందుబాటులో లేవు. ప్రచురించిన వెంటనే ఇక్కడ కనిపిస్తాయి.`,
    nav: {
      home: "హోమ్",
      gita: "భగవద్గీత",
      naamJaap: "నామ జపం",
    ...
    footerCols: {
      ...
      resources: "ఆధ్యాత్మిక నిధులు",
      legal: "నిబంధనలు",
    },
    home: {
      title: "భక్తి వాయిస్ — మీ నిత్య ఆధ్యాత్మిక సాధనా సహచరి",
      description:
        "నామ జపం, భక్తి కథలు, దివ్య తీర్థయాత్రలు, ఆలయాల చరిత్ర, పండుగలు మరియు నిత్య సాధన — ప్రశాంత ఆధ్యాత్మిక నిలయం.",
      h1: "భక్తి కేవలం ఒక భావన మాత్రమే కాదు, అదొక దివ్య జీవన విధానం.",
      sub: "భగవంతునితో అనుసంధానం కండి. ప్రేమతో జపించండి. సార్థకమైన జీవితాన్ని గడపండి.",
      startJaap: "నామ జపం ప్రారంభించండి",
      exploreKatha: "భక్తి కథలను చదవండి",
      devoteesJoined: "చేరిన భక్తులు",
      joinJourney: "భక్తి ప్రయాణంలో చేరండి",
      heroQuote: "భక్తి జీవితాన్ని పరిపూర్ణం చేస్తుంది.",
      globalToday: "ప్రపంచవ్యాప్తంగా భక్తి నామ జపం",
      naamChanted: "ప్రపంచవ్యాప్తంగా భక్తులు చేసిన నామ జపం",
      joinSankalp: "ప్రపంచ సంకల్పంలో చేరండి",
      popularTitle: "ప్రముఖ భక్తి విశేషాలు",
      latestTitle: "భక్తి వాయిస్ తాజా ప్రచురణలు",
      readMore: "మరింత చదవండి",
      moreBlogs: "మరిన్ని బ్లాగులు",
      moreKatha: "మరిన్ని కథలు",
      aartisTitle: "మంగళ హారతులు",
      moreAartis: "మరిన్ని హారతులు",
      krishnaQuote: "భక్తి అనేది అత్యంత పవిత్రమైన ప్రేమ — ఇది ప్రతి శ్వాసను ఒక ప్రార్థనగా మారుస్తుంది.",
      krishnaQuoteBy: "— శ్రీకృష్ణ పరమాత్మ",
      features: [
        { title: "నామ జపం", text: "జపించండి. లెక్కించండి. అనుసంధానం కండి." },
        { title: "నిత్య కథలు", text: "వినండి. తెలుసుకోండి. ఆచరించండి." },
        { title: "పుణ్య తీర్థయాత్రలు", text: "మీ యాత్ర, దైవ కృప." },
        { title: "పవిత్ర పూజా సామగ్రి", text: "పవిత్రమైనవి, విశ్వసనీయమైనవి." },
        { title: "భక్త సమాజం", text: "పంచుకోండి. కలవండి. ప్రేరణ పొందండి." },
        { title: "పండుగలు & క్యాలెండర్", text: "ఏ ఒక్క పవిత్ర పర్వదినాన్నీ మరచిపోకండి." },
      ],
      featuresMore: [
        { title: "చాలీసా", text: "చదవండి. పఠించండి. స్మరించండి." },
        { title: "భక్తి బ్లాగులు", text: "మార్గదర్శకాలు. కథలు. జ్ఞానం." },
        { title: "దివ్య మంత్రాలు", text: "జపించండి. నేర్చుకోండి. సాధించండి." },
        { title: "పుణ్య ఆలయాలు", text: "చరిత్ర. దర్శనం. విశ్వాసం." },
        { title: "మంగళ హారతి", text: "దీపారాధన. స్తోత్రం. భక్తి." },
        { title: "భజనలు", text: "పాడండి. వినండి. లీనమవండి." },
      ],
    },
    hubs: {
      naamJaap: {
        title: "నామ జప కౌంటర్ — ప్రశాంతంగా కూర్చోండి, జపించండి | Bhakti Voice",
        description:
          "రాధే రాధే, శ్రీరామ నామం, హరే కృష్ణ మరియు ఓం నమః శివాయ నామ జపం. 108 పూసల మాల పూర్తి చేయండి, రోజువారీ పురోగతిని నమోదు చేసుకోండి.",
        h1: "నామ జపం",
      },
      mala: {
        title: "108 మాల జపం | Bhakti Voice",
        description: "ప్రశాంతమైన కౌంటర్‌తో 108 పూసల నామ జప మాలను పూర్తి చేయండి.",
        h1: "మాల జపం",
      },
      katha: {
        title: "భక్తి కథలు — వినండి, నేర్చుకోండి, జీవించండి | Bhakti Voice",
        description: "నిత్య శ్రవణానికి దివ్య పురాణ గాథలు మరియు భక్తి కథలు. చదవండి లేదా వినండి — అనంతరం జపం చేయండి.",
        h1: "భక్తి కథలు",
      },
      yatra: {
        title: "పుణ్యభారత దర్శనం — పవిత్ర తీర్థయాత్రల సమగ్ర మార్గదర్శి | Bhakti Voice",
        description: "భక్తుల కోసం రూపొందించిన తీర్థయాత్రా గైడ్స్. ధామాలు, ఆలయాలు, దర్శన సమయాలు మరియు ప్రయాణ వివరాలు.",
        h1: "పుణ్యభారత దర్శనం",
      },
      planner: {
        title: "యాత్రా ప్రణాళిక — ప్రశాంతమైన తీర్థయాత్రను రూపొందించుకోండి",
        description:
          "గమ్యస్థానం, యాత్రా దినాలు, ఆలయ దర్శనం మరియు విశ్రాంతితో కూడిన పరిపూర్ణ యాత్రా ప్రణాళికను సిద్ధం చేసుకోండి.",
        h1: "యాత్రా ప్రణాళిక",
      },
      sadhana: {
        title: "నేటి భక్తి — నిత్య దైవ సాధన | Bhakti Voice",
        description:
          "నామ జపం, పురాణ పఠనం, ధ్యానం, సంకల్పం మరియు వ్రతం — గృహస్థుల కోసం రోజువారీ ఆధ్యాత్మిక సాధన.",
        h1: "నేటి భక్తి సాధన",
      },
      sankalp: {
        title: "నా సంకల్పాలు — నిష్ఠతో ఆచరించదగిన దివ్య వ్రతాలు",
        description: "వ్యక్తిగత నామ జప సంకల్పాన్ని ప్రారంభించండి మరియు ప్రపంచ భక్తుల సంకల్పంలో పాల్గొనండి.",
        h1: "నా సంకల్పాలు",
      },
      diary: {
        title: "భక్తి డైరీ — రోజువారీ సాధనా రికార్డు | Bhakti Voice",
        description:
          "మీ రోజువారీ నామ జపం, భావనలు మరియు సాధనా అనుభవాలను సురక్షితంగా నమోదు చేసుకోండి.",
        h1: "భక్తి డైరీ",
      },
      blog: {
        title: "ఆధ్యాత్మిక బ్లాగులు — యాత్రలు, మంత్రాలు మరియు సాధన | Bhakti Voice",
        description: "భక్తుల కోసం విశేష వ్యాసాలు మరియు మార్గదర్శకాలు. ప్రయాణించే ముందు ఆలయ సమయాలను తెలుసుకోండి.",
        h1: "ఆధ్యాత్మిక బ్లాగులు",
      },
      temples: {
        title: "పుణ్యక్షేత్రాలు & ఆలయాలు — దివ్య దర్శనం మరియు చరిత్ర | Bhakti Voice",
        description: "భారతదేశంలోని ప్రసిద్ధ దేవాలయాల చరిత్ర, స్థల పురాణం, పూజా సమయాలు మరియు దర్శన వివరాలు.",
        h1: "పుణ్యక్షేత్రాలు & ఆలయాలు",
      },
      festivals: {
        title: "హిందూ పండుగలు & వ్రతాలు — విశిష్టత మరియు పూజా విధానం",
        description:
          "హిందూ పండుగలు, శుభ దినాలు, ఏకాదశి వ్రతాలు మరియు పూజా విధివిధానాల సమగ్ర సమాచారం.",
        h1: "పండుగలు & వ్రతాలు",
      },
      mantras: {
        title: "దివ్య మంత్రాలు — నిత్య నామ జప మంత్రాలు | Bhakti Voice",
        description: "శక్తివంతమైన వేద మంత్రాలు, వాటి ఉచ్ఛారణ, అర్థం మరియు జపించే సరైన విధానం.",
        h1: "దివ్య మంత్రాలు",
      },
      spirituality: {
        title: "ఆధ్యాత్మిక జ్ఞానం — భక్తి, ధర్మం మరియు తత్వం | Bhakti Voice",
        description:
          "నామ జపం, మాల, ఏకాదశి, సంకల్పం, భక్తి మరియు సనాతన ధర్మం గురించిన స్పష్టమైన జ్ఞాన బోధనలు.",
        h1: "ఆధ్యాత్మిక జ్ఞానం",
      },
      community: {
        title: "భక్త సమాజం — పంచుకోండి, అనుసంధానం కండి, ప్రేరణ పొందండి",
        description:
          "గ్లోబల్ రామనామ సంకల్పంలో చేరండి. తోటి భక్తులతో కలిసి ఆధ్యాత్మిక సాధనను కొనసాగించండి.",
        h1: "భక్త సమాజం",
      },
      store: {
        title: "భక్తి భండార్ — జపమాలలు, దీపాలు మరియు పూజా సామగ్రి",
        description: "నిత్య సాధన కోసం పవిత్రమైన తులసి మాలలు, రుద్రాక్షలు, దీపాలు మరియు పూజా పరికరాలు.",
        h1: "భక్తి భండార్",
      },
      tithi: {
        title: "ఈరోజు తిథి & పంచాంగం — ఖచ్చితమైన హిందూ పంచాంగం | Bhakti Voice",
        description:
          "ఈరోజు తిథి, పక్షం, మాసం, నక్షత్రం, యోగం, కరణం, రాహుకాలం మరియు శుభ ముహూర్తాల పూర్తి వివరాలు.",
        h1: "ఈరోజు తిథి: నేటి పంచాంగం మరియు క్యాలెండర్ వివరాలు",
      },
      quotes: {
        title: "సుభాషితాలు & సూక్తులు — నిత్య జీవితానికి భక్తి వాక్యాలు",
        description: "జీవితానికి శాంతిని, ప్రేరణను అందించే దివ్య భక్తి సూక్తులు మరియు సుభాషితాలు.",
        h1: "సుభాషితాలు & సూక్తులు",
      },
      bhajan: {
        title: "భజనలు & కీర్తనలు — నిత్య శ్రవణానికి మధుర భక్తి గీతాలు",
        description:
          "మధురమైన భజనలు, కీర్తనలు, వాటి సాహిత్యాలు మరియు భావార్థాల సమాహారం.",
        h1: "భజనలు & కీర్తనలు",
      },
      aarti: {
        title: "మంగళ హారతులు — నిత్య పూజా హారతులు మరియు స్తోత్రాలు",
        description: "దేవీ దేవతల పవిత్ర మంగళ హారతులు, సాహిత్యాలు మరియు హారతి ఇచ్చే విధానం.",
        h1: "మంగళ హారతులు",
      },
      chalisa: {
      ...
      more: {
        ...
        description:
          "భక్తి వాయిస్ అన్ని విభాగాలు: జపం, కథలు, యాత్రలు, ఆలయాలు, పండుగలు, మంత్రాలు మరియు భక్త సమాజం.",
        h1: "మరిన్ని విశేషాలు",
      },
      spiritualTools: {
        title: "ఉచిత ఆధ్యాత్మిక పరికరాలు & వైదిక కాలిక్యులేటర్లు | Bhakti Voice",
        description:
          "ఈరోజు పంచాంగం, ఉచిత జన్మ కుండలి మరియు కుండలి మిలన్ (గుణ మేళనం) మీ పరికరంలోనే సురక్షితంగా లెక్కించండి.",
        h1: "భక్తి వాయిస్ ఆధ్యాత్మిక పరికరాలు",
      },
      panchangTool: {
        title: "ఈరోజు పంచాంగం | ఖచ్చితమైన తిథి, నక్షత్రం & శుభ ముహూర్తం",
        description:
          "మీ నగరానికి సంబంధించిన సమగ్ర పంచాంగం: తిథి, నక్షత్రం, యోగం, కరణం, రాహుకాలం మరియు శుభ ముహూర్తాలు.",
        h1: "రోజువారీ పంచాంగం",
      },
      kundliTool: {
        title: "ఉచిత జన్మ కుండలి ఆన్‌లైన్ | ఖచ్చితమైన జాతక చక్రం",
        description:
          "మీ పూర్తి జన్మ పత్రికను ఉచితంగా ఆన్‌లైన్‌లో పొందండి. 100% సురక్షితం మరియు ప్రైవేట్.",
        h1: "ఉచిత జన్మ కుండలి / జాతక చక్రం",
      },
      kundliMilanTool: {
        title: "కుండలి మిలన్ & 36 గుణాల మేళనం | ఉచిత వివాహ పొంతన",
        description:
          "అష్టకూట పద్ధతిలో 36 గుణాల వివాహ పొంతనను ఉచితంగా లెక్కించండి.",
        h1: "కుండలి మిలన్ / 36 గుణాల మేళనం",
      },
    },
    spiritualTools: {
      privacyNotice: "మీ పుట్టిన వివరాలు మీ పరికరంలోనే స్థానికంగా లెక్కించబడతాయి.",
      allTools: "అన్ని ఆధ్యాత్మిక పరికరాలు",
      openTool: "పరికరము తెరవండి",
      landingLead:
        "100% సురక్షితమైన, ప్రైవేట్ వైదిక కాలిక్యులేటర్లు — పంచాంగం, జన్మ కుండలి మరియు కుండలి మిలన్. మీ బ్రౌజర్ దాటి ఏ వివరాలూ వెళ్లవు.",
      tools: {
        panchang: {
          title: "రోజువారీ పంచాంగం",
          description: "మీ ఖచ్చితమైన ప్రాంతం ప్రకారం నేటి తిథి, నక్షత్రం మరియు ముహూర్తాన్ని పొందండి.",
        },
        kundli: {
          title: "ఉచిత కుండలి",
          description: "మీ ఖచ్చితమైన జన్మ పత్రికను పొందండి. పూర్తిగా ప్రైవేట్ మరియు మీ పరికరంలోనే లెక్కించబడుతుంది.",
        },
        milan: {
          title: "కుండలి మిలన్",
          description: "సాంప్రదాయ 36 గుణాల అష్టకూట పద్ధతిలో వివాహ అనుకూలతను సరిచూసుకోండి.",
        },
      },
      panchang: {
        formTitle: "ప్రాంతం",
        formLead: "మీ నగరాన్ని ఎంచుకోండి లేదా పరికరం లొకేషన్ ఉపయోగించండి. మీ అక్షాంశ, రేఖాంశాల ప్రకారం సమయాలు లెక్కించబడతాయి.",
        useLocation: "నా లొకేషన్ ఉపయోగించండి",
        selectCity: "నగరాన్ని ఎంచుకోండి",
        calculating: "పంచాంగం లెక్కిస్తోంది…",
        resultTitle: "ఈరోజు పంచాంగం",
        weekday: "వారం",
        tithi: "తిథి",
        nakshatra: "నక్షత్రం",
        yoga: "యోగం",
      ...
      kundli: {
        formTitle: "జనన వివరాలు",
        name: "పేరు",
        date: "పుట్టిన తేదీ",
        time: "పుట్టిన సమయం",
        place: "పుట్టిన ప్రదేశం",
        placeHint: "నగరం పేరు టైప్ చేయండి…",
        submit: "కుండలిని రూపొందించండి",
        calculating: "గ్రహ స్థితులను లెక్కిస్తోంది…",
        resultTitle: "మీ జన్మ కుండలి",
        lagna: "లగ్నం",
        moonSign: "చంద్ర రాశి (రాశి)",
        sunSign: "సూర్య రాశి",
      ...
      milan: {
        boyTitle: "వరుని వివరాలు",
        girlTitle: "వధువు వివరాలు",
        name: "పేరు",
        date: "పుట్టిన తేదీ",
        time: "పుట్టిన సమయం",
        place: "పుట్టిన ప్రదేశం",
        placeHint: "నగరం పేరు టైప్ చేయండి…",
        submit: "36 గుణ మిలన్ లెక్కించండి",
        calculating: "గుణాలను సరిపోలుస్తోంది…",
        resultTitle: "అష్టకూట మిలన్ ఫలితం",
        boyDefault: "వరుడు",
        girlDefault: "వధువు",
        boyMoon: "వరుని చంద్రుడు",
        girlMoon: "వధువు చంద్రుడు",
      },
    },
    common: {
      read: "చదవండి",
      listen: "వినండి",
      pauseListen: "విరామం",
      resumeListen: "కొనసాగించండి",
      stopListen: "ఆపండి",
      listening: "వింటున్నారు",
      narratorHint: "స్పష్టమైన భారతీయ వ్యాఖ్యాత ఈ కథను చదువుతారు. ఆపడానికి మళ్లీ నొక్కండి.",
      watch: "వీక్షించండి",
      goHome: "హోమ్‌కు వెళ్లండి",
      exploreYatra: "తీర్థయాత్రలను చూడండి",
      notFoundTitle: "ఈ పేజీ దారి తప్పినట్లుంది.",
      notFoundBody: "మిమ్మల్ని తిరిగి మీ భక్తి ప్రయాణంలోకి తీసుకువద్దాం.",
      notFoundCrumb: "పేజీ కనుగొనబడలేదు",
      searchTitle: "భక్తి వాయిస్‌లో శోధించండి",
      searchResults: (q: string) => `“${q}” కోసం శోధన ఫలితాలు`,
      searchDesc: "మంత్రాలు, యాత్రలు, ఆలయాలు, పండుగలు, కథలు మరియు పూజా వస్తువులను కనుగొనండి.",
      searchEmpty: "ఒక నామం, నగరం లేదా పండుగ పేరును టైప్ చేయండి.",
      searchCount: (n: number, q: string) =>
        `“${q}” కోసం ${n} ఫలితం${n === 1 ? "" : "లు"} లభించాయి`,
      startJaap: "108 నామ జపం ప్రారంభించండి",
      festivalNotes: "పండుగ విశేషాలు",
      afterTithi: "తిథిని తెలుసుకున్న తర్వాత, ప్రశాంతంగా కూర్చోండి.",
      popularKatha: "ప్రముఖ కథలు",
      tags: "ట్యాగ్‌లు",
      noTags: "ఇంకా ట్యాగ్‌లు లేవు.",
      showMoreTags: (n: number) => `+${n} మరిన్ని`,
      showLessTags: "తక్కువ చూపించు",
      followJourney: "భక్తి ప్రయాణాన్ని అనుసరించండి",
      followJourneyBody: "యాత్రలు మరియు జపం కోసం సరికొత్త మార్గదర్శకాలు.",
      blogLead:
        "మీ ఆధ్యాత్మిక ప్రయాణాన్ని సుసంపన్నం చేయడానికి శాశ్వత జ్ఞానం, దైవిక కథలు మరియు సాధనా మార్గదర్శకాలు.",
      blogReadMore: "మరింత చదవండి",
      blogSave: "సేవ్ చేయండి",
      blogSaved: "సేవ్ చేయబడింది",
      blogAuthorFallback: "భక్తి వాయిస్ బృందం",
      blogPromises: [
        { title: "ప్రామాణిక కంటెంట్", text: "అత్యంత శ్రద్ధతో రూపొందించబడింది." },
        { title: "శాశ్వత జ్ఞానం", text: "గృహస్థుల నిత్య జీవితానికి ప్రాచీన విజ్ఞానం." },
        { title: "భక్త సమూహం", text: "సాధన చేసే తోటి భక్తులతో కలిసి సాగండి." },
        { title: "నిరంతర ప్రయాణం", text: "యాత్రలు, జపం మరియు నిత్య సాధనకు కొత్త గైడ్స్." },
      ],
      blogCtaTitle: "108 నామ జపం ప్రారంభించండి",
      blogCtaBody: "చదివిన తర్వాత, కొద్దిసేపు కూర్చోండి. జపమాల మిగిలిన సాధనను పూర్తి చేస్తుంది.",
      blogCtaLabel: "జపం ప్రారంభించండి",
      next: "తరువాత",
      previous: "మునుపటి",
      pageOf: (page: number, total: number) => `పేజీ ${page} / ${total}`,
      festivalTithiLead: "ఈరోజు తిథి కోసం చూడండి",
      bestSellers: "అత్యధిక ఆదరణ పొందినవి",
      globalSankalp: "గ్లోబల్ రామనామ సంకల్పం",
      naamChanted: "జపించిన నామాలు",
      chantingToday: "నేడు జపిస్తున్న భక్తులు",
      joinNow: "ఇప్పుడే చేరండి",
      popularGroups: "ప్రముఖ బృందాలు",
      join: "చేరండి",
      joined: "చేరారు",
      openGroup: "బృందాన్ని తెరవండి",
      communityMembers: "ఈ సంఘంలో ఉన్న భక్తులు",
      communityStart: "సందేశాన్ని ప్రారంభించండి",
      communityReply: "సమాధానం ఇవ్వండి",
      communityPost: "పోస్ట్ చేయండి",
      communityNeedJoin: "వ్యాఖ్యానించడానికి ఈ సంఘంలో చేరండి.",
      communityNeedSignIn: "ఈ సంఘంలో చేరడానికి Google తో సైన్ ఇన్ చేయండి.",
      communityAbuse: "దయచేసి భాషను మర్యాదపూర్వకంగా ఉంచండి.",
      communityEmpty: "ఇంకా సందేశాలు లేవు. మొదటగా ఒక నామాన్ని పంచుకోండి.",
      communityWrite: "సంఘం కోసం చిన్న సందేశం…",
      communityReplyHint: "ఈ చర్చకు సమాధానం ఇవ్వండి…",
      communityCreate: "ఒక సంఘాన్ని సృష్టించండి",
      communityCreateHint: "మీరు గరిష్టంగా 3 సంఘాలను సృష్టించవచ్చు. మీరే అడ్మిన్ అవుతారు.",
      communityName: "సంఘం పేరు",
      communityAbout: "ఈ సంఘం గురించి",
      communityCreateCta: "సృష్టించండి",
      communityAdmin: "అడ్మిన్",
      communityAdminOnly: "కేవలం అడ్మిన్ మాత్రమే పోస్ట్‌ను ప్రారంభించగలరు.",
      communityDevoteeGroups: "భక్త సంఘాలు",
      communityLimit: "మీకు ఇప్పటికే 3 సంఘాలు ఉన్నాయి.",
      devotees: "భక్తులు",
      edit: "సవరించండి",
      dailyQuote: "నేటి సుభాషితం",
      quoteSearch: "సూక్తులను శోధించండి",
      quotesEmpty: "ఇంకా సూక్తులు లేవు.",
      quotesNone: "ఆ శోధనకు సరిపోలే సూక్తులు లేవు.",
      listingSearch: (label: string) => `${label} కోసం శోధించండి...`,
      listingSearchNone: "ఈ పేజీలో ఆ శోధనకు సరిపోలేవి ఏవీ లేవు.",
      bhajanSearchPlaceholder: "భజన, కీర్తన, హారతి, మంత్రం కోసం శోధించండి...",
      gitaQuote: "మనస్సును నియంత్రించని వారికి అది శత్రువులా ప్రవర్తిస్తుంది.",
      gitaSource: "— భగవద్గీత",
      all: "అన్నీ",
      diyasPuja: "దీపాలు & పూజా సెట్లు",
      inProgress: "పురోగతిలో ఉంది",
      noActiveSankalp: "యాక్టివ్ సంకల్పం లేదు",
      sankalpHint: "చిన్న సంకల్పంతో ప్రారంభించండి",
      beginJaap: "జపం ప్రారంభించండి",
      popularSankalps: "ప్రముఖ సంకల్పాలు",
      panchang: "పంచాంగం",
      tithiSunrise: "తిథి (సూర్యోదయం)",
      paksha: "పక్షం",
      masa: "మాసం (పూర్ణిమాంత)",
      vara: "వారం",
      ritu: "ఋతువు",
      nakshatra: "నక్షత్రం",
      yoga: "యోగం",
      ...
      rahuKaal: "రాహుకాలం",
      upcomingTithis: "రాబోయే తిథులు",
      nextDaysSunrise: "సూర్యోదయ తిథులు",
      tithiHolds: (until: string) => `ఈ తిథి ${until} IST వరకు ఉంటుంది. సమయాలు ఢిల్లీ కోసం.`,
      tithiMoved: "సూర్యోదయం తర్వాత తిథి మారింది",
      tithiRunsUntil: (until: string) => `ఇది ${until} IST వరకు కొనసాగుతుంది.`,
      adhikaMasa: "అధిక మాసం",
      vikramSamvat: "విక్రమ సంవత్",
      amanta: "అమాంత",
      pada: (n: number) => `పాదము ${n}`,
      sunrise: "సూర్యోదయం",
      sunset: "సూర్యాస్తమయం",
      tithiStarts: "తిథి ప్రారంభం",
      tithiEnds: "తిథి సమాప్తం",
      nextTithi: "తదుపరి తిథి",
      specialObservances: "నేటి విశేషాలు",
      tithiTimings: "తిథి సమయాలు మరియు సూర్యుడు",
      alignments: "జ్యోతిష విశేషాలు",
      delhiPanchangNote:
        "సమయాలు IST లో సూర్య, చంద్రుల గమనం ఆధారంగా ఖచ్చితంగా లెక్కించబడ్డాయి.",
      tithiJaapTitle: "తిథి తెలిసింది. సాధనలో కూర్చోండి.",
      tithiJaapBody: "నేటి పంచాంగం చూసిన తర్వాత, 108 సార్లు నామ జపం చేయండి.",
      faqTitle: "తరచుగా అడిగే ప్రశ్నలు",
      readMore: "మరింత చదవండి",
      readLess: "తక్కువ చదవండి",
      cartTitle: "మీ కార్ట్",
      cartH1: "మీ కార్ట్ ప్రశాంతమైన పూజా పళ్లెం లాంటిది",
      cartBody:
        "భక్తి భండార్ నుండి మీరు జోడించిన వస్తువులు ఇక్కడ ఉంటాయి.",
      visitStore: "భండార్‌ను సందర్శించండి",
      addToCart: "కార్ట్‌కు జోడించండి",
      addedToCart: "జోడించబడింది",
      outOfStock: "స్టాక్ లేదు",
      outOfStockNote: "ఈ వస్తువు ప్రస్తుతానికి అందుబాటులో లేదు.",
      loginTitle: "భక్తి వాయిస్‌లోకి లాగిన్ అవ్వండి",
      loginBody: "జప సంఖ్యలు, సంకల్పాలు మరియు డైరీని అన్ని పరికరాల్లో భద్రపరుచుకోండి.",
      continueGoogle: "Google తో కొనసాగించండి",
      welcome: "స్వాగతం",
      alreadySignedIn: "మీరు ఇప్పటికే లాగిన్ అయి ఉన్నారు:",
      googleNotConfigured:
        "Google లాగిన్ ప్రస్తుతానికి అందుబాటులో లేదు. మీరు అతిథిగా అన్వేషించవచ్చు.",
      profileTitle: "నా భక్తి ప్రయాణం",
      checkoutTitle: "చెక్‌అవుట్",
      settingsTitle: "సెట్టింగ్‌లు",
      accountTitle: "ఖాతా",
      openDiary: "డైరీ తెరవండి",
      sadhanaDiaryLead: "Google లాగిన్ తర్వాత డైరీని తెరవండి. సేవ్ చేసిన రోజులు క్యాలెండర్‌లో కనిపిస్తాయి.",
      diaryWhereHint:
        "క్యాలెండర్‌లో ముఖ్యాంశాలుగా తేదీలు కనిపిస్తాయి. ఆ రోజు రికార్డును చదవడానికి లేదా సవరించడానికి క్లిక్ చేయండి.",
      diaryNeedSignIn: "మీ డైరీని సేవ్ చేయడానికి Google తో సైన్ ఇన్ చేయండి.",
      saveThisDay: "ఈ రోజును భద్రపరచండి",
      diarySaving: "సేవ్ చేస్తోంది…",
      diarySaved: "మీ ఖాతాలో సేవ్ చేయబడింది",
      diarySignInCta: "సేవ్ చేయడానికి Google తో సైన్ ఇన్ చేయండి",
      diaryLoadError: "డైరీని లోడ్ చేయడం సాధ్యపడలేదు. మళ్లీ ప్రయత్నించండి.",
    },
    sadhana: {
      naamJaap: "ఒక మాల జపం, లేదా పదకొండు నిష్కల్మష నామాలు.",
      katha: "ఒక కథా భాగాన్ని వినండి, దానిని రోజంతా మనస్సులో ఉంచుకోండి.",
      meditation: "హృదయంలో భగవంతుని నామంతో ప్రశాంత ధ్యానం.",
      sankalp: "నిష్టతో నెరవేర్చగల ఒక చిన్న వ్రతం.",
      vrat: "ఆరోగ్యానికి అనుగుణంగా ఏకాదశి వ్రతాచరణ.",
      seva: "సాధనానంతరం తోటివారికి ప్రేమతో చిన్న సేవ.",
      meditationTitle: "ధ్యానం",
      vratTitle: "వ్రతం / ఉపవాసం",
      sevaTitle: "సేవ",
    },
    jaap: {
      counter: "జప కౌంటర్",
      history: "చరిత్ర",
      statistics: "గణాంకాలు",
      achievements: "సాధన విజయాలు",
      today: "నేటి జపం",
      worldwide: "ప్రపంచవ్యాప్తంగా",
      sync: "సింక్ చేయండి",
      syncHint: "సేవ్ చేయడానికి సైన్ ఇన్ చేయండి",
      thisSitting: "ఈ సాధనలో",
      malaCount: (n: number) => `${n} మాలలు`,
      dayStreak: (n: number) => `${n} రోజుల సాధన`,
      continueJaap: "జపం కొనసాగించండి",
      clear: "క్లియర్",
      malaBeads: "జపమాల పూసలు",
      progress: "నేటి పురోగతి",
      dailyTarget: "రోజువారీ లక్ష్యం",
      malaToday: "నేడు పూర్తి చేసిన మాలలు",
      totalJaap: "మొత్తం జపం",
      streak: "సాధనా పరంపర",
      days: (n: number) => `${n} రోజులు`,
      quickActions: "త్వరిత ఎంపికలు",
      mute: "ధ్వని ఆపండి",
      play: "ధ్వని ప్లే చేయండి",
      shareSadhana: "సాధనను పంచుకోండి",
      zenMode: "ధ్యాన మోడ్",
      bellChime: "108 వద్ద గంట శబ్దం",
      hapticFeedback: "స్పర్శ ప్రకంపన",
      completedMalaCelebration: "మాల పూర్తయింది!",
      malaGoal: (target: number, current: number) => `లక్ష్యం: ${target} లో ${current} మాలలు`,
      faqTitle: "తరచుగా అడిగే ప్రశ్నలు",
      faqs: [
        {
          question: "నామ జపం అంటే ఏమిటి?",
          answer:
            "నామ జపం అంటే భగవంతుని దివ్య నామాన్ని — రామ్, రాధే, కృష్ణ, శివ లేదా మీ ఇష్ట దైవ నామాన్ని భక్తితో పునరావృతం చేయడం. సంఖ్య కేవలం ఆలంబన మాత్రమే, భక్తితో కూర్చోవడమే అసలైన సాధన.",
        },
        {
          question: "108 సార్లు (1 మాల) ఎందుకు జపించాలి?",
          answer:
            "108 అనేది పవిత్రమైన సంఖ్య. 27 నక్షత్రాలు, 4 పాదాలు (27 x 4 = 108). ఒక మాల పూర్తి చేయడం ఒక ఆధ్యాత్మిక చక్రాన్ని పూర్తి చేయడంతో సమానం.",
        },
        {
          question: "ఈ జప కౌంటర్‌ను ఎలా ఉపయోగించాలి?",
          answer:
            "ఒక నామాన్ని ఎంచుకోండి, ప్రతి నామానికి సర్కిల్‌ను తాకండి లేదా స్పేస్‌బార్ నొక్కండి. 108 పూర్తయితే ఒక మాల అవుతుంది. సైన్ ఇన్ చేయడం ద్వారా మీ మొత్తం రికార్డును భద్రపరుచుకోవచ్చు.",
        },
        {
          question: "చేతిలో జపమాల తప్పనిసరిగా ఉండాలా?",
          answer:
            "తులసి లేదా రుద్రాక్ష మాల ఉండటం శుభప్రదం, కానీ నామ స్మరణకు మాల లేకపోయినా ఇబ్బంది లేదు. ప్రయాణాలలో లేదా చేతులు ఖాళీగా లేనప్పుడు ఈ డిజిటల్ కౌంటర్ ఉత్తమ సహచరి.",
        },
        {
          question: "ఏ మంత్రాన్ని జపించాలి?",
          answer:
            "మీ హృదయానికి నచ్చిన నామాన్ని ఎంచుకోండి. రాధే రాధే, శ్రీరామ నామం, హరే కృష్ణ మహామంత్రం, ఓం నమః శివాయ, నవోకార మంత్రం ఇక్కడ ఉన్నాయి. గురు ఉపదేశం ఉంటే ఆ మంత్రాన్నే జపించండి.",
        },
        {
          question: "సాధన షేర్ ఎలా పనిచేస్తుంది?",
          answer:
            "మాల పూర్తయిన తర్వాత 'సాధనను పంచుకోండి' క్లిక్ చేసి WhatsApp లేదా Instagram లో అందమైన కార్డును మీ మిత్రులతో పంచుకోవచ్చు.",
        },
        {
          question: "ఒక రోజు సాధన తప్పిపోతే ఏమి చేయాలి?",
          answer:
            "మరుసటి రోజు ప్రేమతో మళ్లీ ప్రారంభించండి. ఒక రోజు మిస్సయినంత మాత్రాన సంకల్పం విరిగిపోదు. కనీసం పదకొండు సార్లు అయినా నామాన్ని స్మరించండి.",
        },
        {
          question: "గట్టిగా జపించాలా లేక మానసికంగా జపించాలా?",
          answer:
            "రెండు పద్ధతులూ పవిత్రమైనవే. పెదవులు కదుపుతూ ఉపాంశు జపం చేయవచ్చు లేదా మనస్సులోనే మానసిక జపం చేయవచ్చు. ఏకాగ్రత కోసం ధ్వనిని కూడా ఆన్ చేసుకోవచ్చు.",
        },
      ],
    },
    listingFaqs: {
      aarti: [
        {
          question: "మంగళ హారతులు అంటే ఏమిటి, ఈ పేజీని ఎలా ఉపయోగించాలి?",
          answer:
            "మంగళ హారతులు అంటే ఆలయంలో లేదా ఇంట్లో దీపారాధన సమయంలో భగవంతునికి సమర్పించే పవిత్ర గీతాలు. ఇక్కడ వాటి సాహిత్యం, భావార్థం లభిస్తాయి. హారతి ఇచ్చి ప్రశాంతంగా నామ జపంలో లీనమవండి.",
        },
        {
          question: "పూజారి లేకుండా ఇంట్లోనే సాయంత్రం హారతి ఎలా ఇవ్వాలి?",
          answer:
            "చేతులు శుభ్రం చేసుకొని, దీపం వెలిగించి, ఇష్టదైవం ముందు హారతిని తిప్పుతూ శ్రద్ధతో హారతి పాటను పాడండి. భగవంతునికి ఆడంబరం కంటే మీ భక్తి ముఖ్యమైనది.",
        },
        {
          question: "ఇవి ప్రముఖ ఆలయాల ప్రామాణిక సాహిత్యాలేనా?",
          answer:
            "వివిధ సంప్రదాయాలలో కొద్దిపాటి పదాల మార్పులు ఉండవచ్చు. ఇవి నిత్య అధ్యయనం కోసం అందించిన ప్రామాణిక ప్రార్థనా గీతాలు.",
        },
        {
          question: "ఫోన్‌లో హారతి వినడం కూడా సాధనగా పరిగణించబడుతుందా?",
          answer:
            "అవును, శ్రద్ధతో వింటే అది కూడా సాధనే. హారతి పూర్తయిన తర్వాత కొద్దిసేపు కూర్చుని నామ జపం చేయండి.",
        },
        {
          question: "హారతి తర్వాత ఏమి చేయాలి?",
          answer:
            "కొద్దిసేపు నిశ్శబ్దంగా కూర్చోండి. కనీసం 11 సార్లు లేదా ఒక మాల 108 సార్లు నామ జపం చేయండి. భక్తి డైరీలో ఆ రోజు అనుభవాన్ని నమోదు చేసుకోండి.",
        },
      ],
      chalisa: [
        {
          question: "చాలీసా అంటే ఏమిటి, దీనిని ఎలా పఠించాలి?",
          answer:
            "చాలీసా అంటే నలభై చరణాలు కలిగిన దివ్య స్తోత్రం. హనుమాన్ చాలీసా అత్యంత ప్రసిద్ధమైనది. శ్రద్ధతో, నిదానంగా ప్రతి రోజూ పఠించండి.",
        },
        {
          question: "ఇంట్లో స్వయంగా చాలీసా పారాయణ చేయవచ్చా?",
          answer:
            "ఖచ్చితంగా చేయవచ్చు. శుచిగా కూర్చుని, హృదయపూర్వకంగా పారాయణ చేయండి. అనంతరం కొద్దిసేపు నామ జపం చేయండి.",
        },
        {
      ...
      bhajan: [
        {
          question: "భజన మరియు కీర్తనల ప్రాముఖ్యత ఏమిటి?",
          answer:
            "భజనలు హృదయంలో భక్తి భావాన్ని మేల్కొల్పుతాయి. కీర్తనల ద్వారా సామూహికంగా భగవన్నామ స్మరణ జరుగుతుంది. ఇది సాధనలో ఏకాగ్రతను పెంచుతుంది.",
        },
        {
          question: "నిత్య సాధనలో భజనలను ఎలా ఉపయోగించుకోవాలి?",
          answer:
            "ముందుగా అర్థాన్ని గ్రహించండి, అనంతరం మధురంగా పాడుకోండి. భజన తర్వాత ప్రశాంతంగా కూర్చుని నామ జపం చేయండి.",
        },
        {
          question: "కీర్తన పాడటానికి వాయిద్యాలు తప్పనిసరిగా ఉండాలా?",
          answer:
            "అవసరం లేదు. కేవలం చప్పట్లు కొడుతూ లేదా మనస్సులోనే పాడుకున్నా భగవంతుడు స్వీకరిస్తాడు.",
        },
        {
          question: "కృష్ణ భజనలు మరియు రామ భజనల మధ్య తేడా ఏమిటి?",
          answer:
            "రూపాలు వేరైనా పరబ్రహ్మ తత్వం ఒక్కటే. మీ హృదయానికి నచ్చిన ఇష్టదైవాన్ని ఆరాధించండి.",
        },
        {
          question: "భజన సాహిత్యం చదువుతూ ఎలా సాధన చేయాలి?",
          answer:
            "భావార్థాన్ని మననం చేసుకుంటూ పాడండి. అది మనస్సుకు పరమ శాంతిని ప్రసాదిస్తుంది.",
        },
      ],
      blog: [
        {
          question: "భక్తి బ్లాగులు ఎవరి కోసం ఉద్దేశించినవి?",
          answer:
            "గృహస్థులు, సాధకులు మరియు భక్తులందరి కోసం. తీర్థయాత్రలు, మంత్రాలు, పండుగల విశేషాలు మరియు జీవన విధానాన్ని ఇక్కడ సులభంగా తెలుసుకోవచ్చు.",
        },
        {
          question: "ఈ వ్యాసాలను ఎలా చదవాలి?",
          answer:
            "ఒక్క వ్యాసాన్ని నిదానంగా చదవండి. దానిలోని సారాంశాన్ని రోజంతా మననం చేసుకోండి.",
        },
        {
          question: "బ్లాగ్ మార్గదర్శకాలు గురువు లేదా పూజారికి ప్రత్యామ్నాయమా?",
          answer:
            "కాదు. ఇవి సాధనలో సహాయపడే సమాచారం మాత్రమే. శాస్త్ర విహితమైన నిర్ణయాలకు స్థానిక గురువులు, పంచాంగాన్ని సంప్రదించండి.",
        },
        {
          question: "ఇందులో ఏయే విషయాలు ఉంటాయి?",
          answer:
            "యాత్రా మార్గదర్శకాలు, మంత్ర సాధన, వ్రత విధానాలు, ఆలయ చరిత్ర మరియు నిత్య సాధనా సూచనలు ఉంటాయి.",
        },
        {
          question: "ఈ వ్యాసాలను ఇతరులతో పంచుకోవచ్చా?",
          answer:
            "ఖచ్చితంగా. మంచి ఆధ్యాత్మిక సమాచారాన్ని కుటుంబ సభ్యులు, మిత్రులతో పంచుకోవడం ఎంతో పుణ్యప్రదం.",
        },
      ],
      store: [
        {
          question: "భక్తి భండార్‌లో ఏయే వస్తువులు లభిస్తాయి?",
          answer:
            "సాధనకు అవసరమైన తులసి మాలలు, జపమాలలు, దీపాలు, పూజా పళ్లెం మరియు ఇతర పవిత్ర వస్తువులు లభిస్తాయి.",
        },
        {
          question: "నామ జపం చేయడానికి ఇక్కడి నుండే మాల కొనాలా?",
          answer:
            "అవసరం లేదు. మీ దగ్గర ఇప్పటికే ఉన్న మాలతో లేదా ఈ వెబ్‌సైట్‌లోని ఉచిత డిజిటల్ కౌంటర్‌తో వెంటనే జపం ప్రారంభించవచ్చు.",
        },
        {
          question: "ఈ పూజా వస్తువుల నాణ్యత ఎలా ఉంటుంది?",
          answer:
            "ప్రతి వస్తువు పరిశుద్ధమైనది, సాధనకు అనుకూలమైన రీతిలో జాగ్రత్తగా ఎంపిక చేయబడింది.",
        },
        {
          question: "తులసి మాల మరియు ఇతర మాలల మధ్య తేడా ఏమిటి?",
          answer:
            "వైష్ణవ సాధనలో రాముడు, కృష్ణుని జపానికి తులసి మాల ప్రశస్తం. శివారాధనకు రుద్రాక్ష మాల అత్యుత్తమం.",
        },
        {
          question: "ఆర్డర్ చేసిన వస్తువులను ఎలా ఉపయోగించాలి?",
          answer:
            "పూజా మందిరంలో పవిత్రంగా ఉంచి, నిత్య సాధనలో ఉపయోగించుకోండి.",
        },
      ],
      sadhana: [
        {
          question: "నిత్య భక్తి సాధన అంటే ఏమిటి?",
          answer:
            "రోజువారీ జీవితంలో నామ జపం, పురాణ శ్రవణం, చిన్న ధ్యానం మరియు తోటివారికి ప్రేమతో సేవ చేయడం నిత్య సాధన.",
        },
        {
          question: "రోజూ కేవలం 10 నిమిషాలు మాత్రమే ఉంటే సాధన ఎలా చేయాలి?",
          answer:
            "పది నిమిషాల్లో ప్రశాంతంగా కూర్చుని 108 సార్లు ఇష్టదైవ నామాన్ని జపించండి. అది రోజంతా శాంతిని ఇస్తుంది.",
        },
        {
          question: "నామ జపం, సంకల్పం, వ్రతాల మధ్య తేడా ఏమిటి?",
          answer:
            "నామ జపం నిత్య సాధన. సంకల్పం అంటే ఒక నిర్ణీత కాలం లేదా సంఖ్యను నిర్ణయించుకోవడం. వ్రతం అంటే పర్వదినాన ఆహార నియమాలతో చేసే ఉపవాసం.",
        },
        {
          question: "సాధన చేయడానికి ఖాతా తెరవడం తప్పనిసరిగా ఉండాలా?",
          answer:
            "లేదు. ఎవరైనా అతిథిగా ఉచితంగా జపించవచ్చు. మీ రికార్డులను శాశ్వతంగా భద్రపరచడానికి మాత్రమే సైన్ ఇన్ అవసరం.",
        },
        {
          question: "ఏదైనా రోజు సాధన చేయలేకపోతే ఏమి చేయాలి?",
          answer:
            "చింతించకండి. మరుసటి రోజు ఉత్సాహంతో ప్రారంభించండి. భగవంతుడు మీ ప్రేమను, ప్రయత్నాన్ని మాత్రమే చూస్తాడు.",
        },
      ],
      diary: [
        {
          question: "భక్తి డైరీ అంటే ఏమిటి, దీని ప్రయోజనం ఏమిటి?",
          answer:
            "ఇది మీ వ్యక్తిగత ఆధ్యాత్మిక రికార్డు. మీరు చేసిన జపం, ఆ రోజు అనుభవాలను రాసుకోవడానికి ఇది ఉపయోగపడుతుంది.",
        },
        {
          question: "డైరీని భద్రపరచడానికి సైన్ ఇన్ అవసరమా?",
          answer:
            "అవును, మీ వ్యక్తిగత డైరీని ఇతర పరికరాల్లో కూడా చూడటానికి Google తో సైన్ ఇన్ చేయడం అవసరం.",
        },
        {
          question: "డైరీలో ఏమి రాయాలి?",
          answer:
            "ఆ రోజు మీరు చేసిన జప సంఖ్య, చదివిన శ్లోకం లేదా మీ మనస్సులోని భక్తి భావనను చిన్న వాక్యంలో రాసుకోవచ్చు.",
        },
        {
          question: "ఇది ఇతరులకు కనిపిస్తుందా?",
          answer:
            "లేదు, మీ భక్తి డైరీ పూర్తిగా మీ వ్యక్తిగతం మరియు సురక్షితం.",
        },
        {
          question: "డైరీని క్రమం తప్పకుండా ఎలా నిర్వహించాలి?",
          answer:
            "రాత్రి పడుకునే ముందు లేదా సాయంత్రం జపం పూర్తయిన వెంటనే ఒక నిమిషం వెచ్చించి నమోదు చేసుకోండి.",
        },
      ],
    },
    emptyLabels: {
    ...
    planner: {
      darshan: "మొదట దర్శనం",
      darshanText: "యాత్రలో ప్రధాన ఆలయ దర్శనానికి ప్రాధాన్యత.",
      rest: "విశ్రాంతి సమయం",
      restText: "సాయంత్రం ఘాట్ దర్శనం లేదా విశ్రాంతి కోసం.",
      group: "కుటుంబం కోసం",
      groupText: "పెద్దలు మరియు పిల్లల సౌకర్యానికి తగిన వేగం.",
      local: "స్థానిక నిర్ధారణ",
      localText: "ఆలయ సమయాలు మరియు పాస్‌లను స్థానికంగా నిర్ధారించుకోండి.",
      destination: "గమ్యస్థానం",
      startDate: "ప్రారంభ తేదీ",
      days: "రోజులు",
      placeholder: "ఇంకా యాత్రలు ప్రచురించబడలేదు — స్థలాన్ని టైప్ చేయండి",
    },
  },
