...
export const SPIRITUAL_TOOL_KEYWORDS = {
  landing: [
    ...
    "online japa counter",
    "vedic astrology tools online",
    "free panchang today",
    "hindu calendar with tithi",
    "sade sati calculator online",
    "kaal sarp dosha check online",
    "manglik dosha calculator online",
  ],
  landingHi: [
    "आध्यात्मिक टूल्स",
    "वैदिक कैलकुलेटर ऑनलाइन",
    "मुफ्त जन्म कुंडली ऑनलाइन",
    "कुंडली मिलान हिंदी",
    "आज का पंचांग 2026",
    "आज का चौघड़िया",
    "शुभ मुहूर्त कैलकुलेटर",
    "ऑनलाइन नाम जप काउंटर",
    "हिन्दू पंचांग टूल्स",
    "ऑनलाइन वैदिक टूल्स",
    "फ्री पंचांग आज का",
    "आज की तिथि और चौघड़िया",
    "काल सर्प दोष चेक करें",
    "साढ़े साती चेक करें",
    "मांगलिक दोष कैलकुलेटर हिंदी",
  ],
  landingTe: [
    "ఆధ్యాత్మిక సాధనాలు",
    ...
    "నేటి చోఘడియా",
    "శుభ ముహూర్తాలు",
    "ఆన్‌లైన్ నామ జప కౌంటర్",
    "తెలుగు పంచాంగం నేడు",
    "ఉచిత జాతకం ఆన్‌లైన్",
    "ఏలినాటి శని కాలిక్యులేటర్",
    "కాల సర్ప దోష నివారణ",
    "మాంగ్లిక్ దోషం తెలుగు",
    "నేటి తిథి మరియు నక్షత్రం",
  ],
  panchang: [
    "daily panchang",
    "aaj ka panchang",
  ...
  kundli: [
    ...
    "free kundli online",
    "janam kundli online",
    "free janam kundli by date of birth and time",
    "janam kundli by date of birth and time in hindi",
    "free kundli matching",
    "free kundli analysis in hindi",
    "janam kundli kaise nikale",
    "kundli in hindi free",
    "online kundli reading",
    "birth chart calculator vedic",
    ...
    "navamsha chart d9 calculator",
    "dashamsha chart d10",
    "ashtakavarga calculator 337 bindus",
    "sarvashtakavarga points calculator",
    "parashari ashtakavarga online",
    "south indian kundli online",
    "east indian kundli chart",
    "kundli kaise dekhe hindi",
    "janam kundali online free in hindi",
    "manglik dosha calculator",
    "sade sati calculator without birth time",
    "vimshottari dasha calculator free",
    "kaal sarp dosha calculator free",
    "shani sade sati report",
    "mangal dosha check by dob",
    "lagna chart analysis",
  ],
  kundliHi: [
    "मुफ्त जन्म कुंडली",
    "फ्री जन्म कुंडली ऑनलाइन",
    "जन्म कुंडली ऑनलाइन बनाएं",
    "जन्म कुंडली जन्म तिथि और समय से",
    "जन्म पत्रिका जन्म तिथि से",
    "जन्म कुंडली कैसे निकाले",
    "कुंडली कैसे देखें",
    "फ्री जन्म कुंडली इन हिंदी",
    "नवांश कुंडली D9",
    "दशमांश कुंडली D10",
    "अष्टकवर्ग कैलकुलेटर 337 बिंदु",
    "विंशोत्तरी महादशा कैलकुलेटर",
    "मांगलिक दोष जांचें",
    ...
    "मंगल दोष विचार",
    "कुंडली फलादेश हिंदी में",
  ],
  kundliTe: [
    "ఉచిత జన్మ కుండలి",
    "ఉచిత జన్మ కుండలి ఆన్‌లైన్",
    "జన్మ జాతక చక్రం ఆన్‌లైన్",
    "తేదీ మరియు సమయంతో జాతకం",
    "జాతక చక్రం వేయడం ఎలా",
    "నవాంశ చక్రం D9",
    "వింశోత్తరి దశ కాలిక్యులేటర్",
    "అష్టకవర్గ బిందువులు",
    "మాంగ్లిక్ దోష విచారం",
    "దక్షిణ భారత జాతక చక్రం",
    "ఉచిత వైదిక జాతకం",
    "కాల సర్ప దోషం రకాలు",
    "శ్రీకాళహస్తి కాలసర్ప దోష నివారణ",
    "ఏలినాటి శని నివారణలు",
    "కుజ దోష పరిహారాలు",
  ],
  milan: [
    "kundli milan",
    ...
    "kundali matching for marriage by date of birth and time",
    "marriage matching by date of birth",
    "ashtakoot matching online",
    "36 guna milan by date of birth",
    "kundli milan janam tithi se",
    "gun milan jaruri hai kya",
    "kundli matching for marriage free",
    "horoscope matching for marriage",
    "nadi dosha matching",
    "bhakoot dosha remedies in kundli milan",
    "patrika milan online",
    "online gun milan in hindi",
    "36 gun milan chart",
    "kundali matching for marriage in telugu",
    "kundli matching free in hindi",
    "marriage compatibility report",
  ],
  milanHi: [
    "कुंडली मिलान",
    "गुण मिलान विवाह हेतु",
    "३६ गुण मिलान जन्म तिथि से",
    "कुंडली मिलान जन्म तिथि से",
    "वर वधू कुंडली मिलान ऑनलाइन",
    "अष्टकूट गुण मिलान",
    "नाड़ी दोष मिलान",
    "भकूट दोष विचार",
    "विवाह हेतु पत्रिका मिलान",
    "मुफ्त कुंडली मिलान",
    "36 गुण मिलान चार्ट",
    "विवाह हेतु कुंडली मिलान हिंदी",
    "नाड़ी दोष उपाय",
  ],
  milanTe: [
    "కుండలి మిలనం",
    ...
    "36 గుణాల జాతక పొంతన",
    "వివాహ జాతక సరిపోలిక",
    "అష్టకూట మిలనం ఆన్‌లైన్",
    "నాడీ దోష నివారణ",
    "ఉచిత కుండలి మిలనం తెలుగు",
    "పెళ్లి జాతక పొంతన",
    "36 గుణాల వివాహ మిలనం",
    "నాడీ దోషం పరిహారం",
  ],
} as const;
