...
export default async function TemplesIndexPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8 lg:py-12">
      ...
      />
      <Breadcrumbs items={localizedCrumbs(t.homeName, [t.hubs.temples.h1, PATHS.temples])} />
      <h1 className="mt-4 font-serif text-4xl text-ink lg:text-5xl">{t.hubs.temples.h1}</h1>
      {temples.length ? (
