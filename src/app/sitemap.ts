...
const HUBS: { path: string; changeFrequency: MetadataRoute.Sitemap[0]["changeFrequency"]; priority: number }[] = [
  ...
  { path: PATHS.yatra, changeFrequency: "weekly", priority: 0.85 },
  ...
  { path: PATHS.library, changeFrequency: "weekly", priority: 0.85 },
  { path: PATHS.angelNumbers, changeFrequency: "daily", priority: 0.9 },
];
