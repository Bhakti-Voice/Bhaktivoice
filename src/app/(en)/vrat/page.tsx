...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = isTe
    ? "హిందూ వ్రతాలు & ఉపవాసాలు 2026 — 24 ఏకాదశి, పారణ సమయాలు, ప్రదోషం, సంకష్ట చతుర్థి & పౌర్ణమి"
    : isHi
  ...
  const description = isTe
    ? "సంపూర్ణ హిందూ వ్రతాలు మరియు ఉపవాసాల మార్గదర్శి 2026. అన్ని 24 ఏకాదశి తేదీలు, శాస్త్రోక్త పారణ సమయాలు, ప్రదోష వ్రతం, సంకష్ట హర చతుర్థి మరియు ఉపవాస నియమాలు."
    : isHi
  ...
  return localizedMetadata({
    ...
    keywords: isTe
      ? [
          ...
          "ఏకాదశి పారణ సమయాలు",
          "ప్రదోష వ్రతం 2026",
          "సంకష్ట హర చతుర్థి చంద్రోదయం",
          "మాస శివరాత్రి వ్రతం",
          "పౌర్ణమి వ్రత నియమాలు",
          "అమావాస్య పితృ తర్పణం",
          "ఉపవాస నియమాలు",
        ]
      : isHi
      ? [
          "एकादशी 2026 व्रत तिथियाँ",
          "आज कौन सी एकादशी है कथा",
          "प्रदोष व्रत 2026 कब है",
          "अमावस्या 2026 कब की है",
          "शिवरात्रि 2026 डेट एंड टाइम",
      ...
      : [
          "ekadashi dates 2026",
          "ekadashi 2026 fasting time",
          "aaj konsi ekadashi hai",
          "shivratri 2026 date and time",
