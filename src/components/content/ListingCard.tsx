  ...
  const body = (
    <>
      ...
      <div className="flex flex-col flex-1 p-4 sm:p-5">
        ...
        <h2 className="listing-card-title font-serif text-[16px] sm:text-[17px] font-bold leading-snug text-[#2c1810] group-hover:text-saffron-deep transition-colors line-clamp-2">
          {title}
        </h2>
