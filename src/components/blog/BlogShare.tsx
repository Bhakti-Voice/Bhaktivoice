...
export function BlogShare({ title, path }: { title: string; path: string }) {
  ...
  const brandBtn =
    "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-white transition hover:opacity-90";
  ...
  return (
    <aside className="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-line">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        ...
        >
          <Link2 className="h-4 w-4 text-[#2b7de9]" aria-hidden />
