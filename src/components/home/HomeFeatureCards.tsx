  ...
  const features: FeatureItem[] = [
    {
      ...
      badge: isTe ? "రోజువారీ" : isHi ? "दैनिक" : "Daily",
      color: "#d97706",
    ...
    },
    {
      ...
      icon: PanchangIcon,
      title: isTe ? "నేటి చోఘడియా" : isHi ? "आज का चौघड़िया" : "Today's Choghadiya",
      text: isTe ? "అమృత, శుభ & లాభ ముహూర్తాలు" : isHi ? "अमृत, शुभ व लाभ मुहूर्त" : "Amrit, Shubh & Labh",
      badge: isTe ? "శుభ వేళ" : isHi ? "शुभ वेला" : "Muhurat",
      color: "#f59e0b",
    ...
    },
    {
      ...
      title: isTe ? "నామ జప కౌంటర్" : isHi ? "नाम जप काउंटर" : "Naam Jaap",
      text: isTe ? "108 మణులు & ధ్యానం" : isHi ? "१०८ मनके व ध्यान" : "108 Beads & Dhyan",
      badge: "Live",
      color: "#e67e22",
    ...
    },
    {
      href: PATHS.chalisa,
      icon: ChalisaIcon,
      title: isTe ? "చాలీసా సంగ్రహం" : isHi ? "चालीसा संग्रह" : "Chalisa Sangrah",
      text: isTe ? "హనుమాన్, శివ & దుర్గ" : isHi ? "हनुमान व शिव चालीसा" : "Hanuman, Shiva & Durga",
      color: "#e11d48",
    ...
    },
    {
      href: PATHS.aarti,
      icon: AartiIcon,
      title: isTe ? "నిత్య హారతులు" : isHi ? "दैनिक आरती" : "Aarti Sangrah",
      text: isTe ? "దైవిక హారతుల సంగ్రహం" : isHi ? "नित्य आरती संग्रह" : "Daily Sacred Aarti",
      color: "#c026d3",
    ...
    },
    {
      href: PATHS.mantras,
      icon: MantraIcon,
      title: isTe ? "వేద మంత్రాలు" : isHi ? "वैदिक मंत्र" : "Sacred Mantras",
      text: isTe ? "మంత్ర జపం & తాత్పర్యం" : isHi ? "मंत्र जाप व अर्थ" : "Vedic Mantras & Meaning",
      color: "#4f46e5",
    ...
    },
    {
      href: PATHS.katha,
      icon: OpenBookIcon,
      title: isTe ? "పౌరాణిక గాథలు" : isHi ? "पौराणिक कथाएं" : "Puranic Katha",
      text: isTe ? "వ్రత & భక్తి కథలు" : isHi ? "व्रत व भक्ति कथाएं" : "Vrat & Devotional Stories",
      color: "#b45309",
    ...
    },
    {
      ...
      title: isTe ? "పండుగలు & ఉత్సవాలు" : isHi ? "त्योहार व पर्व" : "Festivals",
      text: isTe ? "సనాతన పర్వదినాలు" : isHi ? "सनातन पर्व व तिथियां" : "Sanatan Celebrations",
      color: "#d97706",
      bgGrad: "from-amber-500/15 via-orange-500/10 to-amber-500/5",
    },
    {
      href: PATHS.temples,
      icon: ShrineIcon,
      title: isTe ? "పుణ్య క్షేత్రాలు" : isHi ? "पवित्र मंदिर" : "Hindu Temples",
      text: isTe ? "తీర్థయాత్ర & దర్శన విశేషాలు" : isHi ? "तीर्थ व दर्शन इतिहास" : "Sacred Temples & Darshan",
      color: "#92400e",
    ...
    },
    {
      href: PATHS.yatra,
      icon: TempleIcon,
      title: isTe ? "తీర్థ యాత్ర" : isHi ? "तीर्थ यात्रा" : "Yatra Guide",
      text: isTe ? "చార్ ధామ్ & యాత్రా మార్గదర్శి" : isHi ? "चार धाम व मार्गदर्शिका" : "Char Dham & Pilgrimage",
      color: "#854d0e",
    ...
    },
    {
      href: PATHS.bhajan,
      icon: BhajanIcon,
      title: isTe ? "భక్తి సంకీర్తనలు" : isHi ? "भक्ति भजन" : "Bhakti Bhajans",
      text: isTe ? "మధుర భజనలు & సాహిత్యం" : isHi ? "मधुर भजन व संकीर्तन" : "Devotional Audio & Lyrics",
      color: "#0f766e",
    ...
    },
    {
      ...
      icon: CommunityIcon,
      title: isTe ? "భక్త పరివారం" : isHi ? "भक्त परिवार" : "Devotee Community",
      text: isTe ? "సత్సంగం & ఆలోచనలు" : isHi ? "सत्संग व विचार साझा करें" : "Devotees & Daily Sangha",
      color: "#7c3aed",
    ...
    },
    {
      href: PATHS.store,
      icon: LotusIcon,
      title: isTe ? "పూజా సామగ్రి" : isHi ? "पूजा सामग्री" : "Puja Store",
      text: isTe ? "రుద్రాక్ష & పూజా వస్తువులు" : isHi ? "रुद्राक्ष व पवित्र माला" : "Rudraksha & Puja Essentials",
      color: "#c2410c",
    ...
    },
    {
      href: PATHS.blog,
      icon: BlogIcon,
      title: isTe ? "ధార్మిక వ్యాసాలు" : isHi ? "धार्मिक लेख" : "Spiritual Blog",
      text: isTe ? "జ్ఞానం, విధి & సాధన" : isHi ? "ज्ञान, विधि व साधना" : "Spiritual Insights & Guides",
      color: "#374151",
