  ...
  const categories: QuickLinkCategory[] = [
    // 1. Shubh Muhurats & Choghadiya
    {
      ...
      links: [
        ...
        { href: PATHS.regionalPanchang("month-panchang"), label: isHi ? "शुभ विवाह मुहूर्त 2026" : "Vivah Muhurat (Wedding Dates)", featured: true },
        { href: PATHS.regionalPanchang("month-panchang"), label: isHi ? "गृह प्रवेश एवं वास्तु मुहूर्त" : "Griha Pravesh Muhurat" },
        { href: PATHS.regionalPanchang("month-panchang"), label: isHi ? "संपत्ति एवं भूमि रजिस्ट्री मुहूर्त" : "Property Purchase Muhurat" },
        { href: PATHS.regionalPanchang("month-panchang"), label: isHi ? "वाहन क्रय मुहूर्त (कार/बाइक)" : "Vehicle Purchase Muhurat" },
