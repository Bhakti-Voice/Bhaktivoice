...
export function MuhuratMenu({ mobile = false, onNavigate }: { mobile?: boolean; onNavigate?: () => void }) {
    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          ...
          className="absolute left-1/2 -translate-x-1/3 top-full z-50 mt-2 w-[620px] animate-in fade-in zoom-in-95 duration-150 rounded-2xl border border-line bg-[#fffbf6] p-4 shadow-2xl ring-1 ring-black/5 backdrop-blur-md"
        >
